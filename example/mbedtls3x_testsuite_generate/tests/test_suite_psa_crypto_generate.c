 ...
 *
 * Test file      : tests/test_suite_psa_crypto_generate.c
 *
 ...
 *      Test suite file     : tests/test_suite_psa_crypto_generate.function
 *      Test suite data     : tests/test_suite_psa_crypto_generate.data
 *
 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
    test_generate_opaque_key_wrapper,
#else
    NULL,
#endif
/* Function Id: 1 */
...
#if defined(MBEDTLS_PSA_CRYPTO_C)
    test_generate_persistent_key_wrapper,
#else
    NULL,
#endif
/* Function Id: 2 */
...
int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "tests/test_suite_psa_crypto_generate.datax";
