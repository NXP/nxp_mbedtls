 ...
 *
 * Test file      : tests/test_suite_psa_crypto_entropy.c
 *
 ...
 *      Test suite file     : ../../tests/suites/test_suite_psa_crypto_entropy.function
 *      Test suite data     : ../../tests/suites/test_suite_psa_crypto_entropy.data
 *
 */
...
int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "tests/test_suite_psa_crypto_entropy.datax";
