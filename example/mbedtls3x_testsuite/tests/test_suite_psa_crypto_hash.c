 ...
 *
 * Test file      : tests/test_suite_psa_crypto_hash.c
 *
 ...
 *      Test suite file     : ../../tests/suites/test_suite_psa_crypto_hash.function
 *      Test suite data     : ../../tests/suites/test_suite_psa_crypto_hash.data
 *
 */
...
int execute_tests(int argc, const char **argv)
{
    ...
    const char *default_filename = "tests/test_suite_psa_crypto_hash.datax";
